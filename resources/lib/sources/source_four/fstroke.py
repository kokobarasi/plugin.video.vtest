...
dict_keys   = os.path.join(xbmc.translatePath('special://home/'), keys_path + "keys_fs.json")
...
path_dicts, mode_fs_list = mode_keys()[0], mode_keys()[number.assign_num(number.mode_keys, 'fshome')]
path_dict = load_keys()
...
def fetch_links(m_part, min_search = 1, max_search = 2):
    ...
    movie_src = page_download.playable_links_tup(selector_list = '.post-image a',
                                                 ...
                                                 attr_option = 'https://familystrokesporn.com/',
        
                                                 sieve_str = True,
                                                 sieve_pattern = 'file:\s+"(.*\.mp4)"'
                                                 )
